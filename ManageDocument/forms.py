...
class DocumentDateAndTime(forms.Form):
    nowSelector = forms.BooleanField(widget=forms.CheckboxInput(attrs={'id':'nowSelector'}), required=True)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['date'] = forms.DateField(widget=forms.SelectDateWidget(attrs={'id':'DateField', 'min':thisDate.year, \
            'max':thisDate.year+1, 'value':thisDate.year}), required=False)
